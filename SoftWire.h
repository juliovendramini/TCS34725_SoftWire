/*
  Código adaptado da biblioteca https://github.com/stevemarple/SoftWire
  adaptação feita por Julio Cesar Goldner Vendramini
  Esta adaptação foi feita para que a biblioteca funcione com a biblioteca (também adaptada) TCS34725.h
